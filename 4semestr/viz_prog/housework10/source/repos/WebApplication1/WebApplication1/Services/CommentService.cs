...
public class CommentService
{
    ...
    public Comment? PartialUpdate(int id, Dictionary<string, object> patch) =>
        _repository.PartialUpdate(id, patch);

    public Comment? Delete(int id) => _repository.Delete(id);
}